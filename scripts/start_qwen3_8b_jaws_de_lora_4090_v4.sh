...
CONFIG_REL="training/transformers/qwen3_8b_jaws_de_lora_4090_v4.yaml"
RUN_NAME="qwen3_8b_jaws_de_lora_4090_v4"
...
usage() {
  echo "Usage:"
  echo "  scripts/start_qwen3_8b_jaws_de_lora_4090_v4.sh"
  echo "  scripts/start_qwen3_8b_jaws_de_lora_4090_v4.sh --resume-latest"
  echo "  scripts/start_qwen3_8b_jaws_de_lora_4090_v4.sh --resume-from <checkpoint-dir>"
}
...
echo "Next step:"
echo "  scripts/run_qwen3_8b_jaws_de_lora_4090_v4_smoke.sh"
