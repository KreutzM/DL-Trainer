...
usage() {
  ...
  echo "  scripts/start_qwen3_8b_jaws_de_lora_4090_v2.sh --resume-latest"
  echo "  scripts/start_qwen3_8b_jaws_de_lora_4090_v2.sh --resume-from <checkpoint-dir>"
}
...
echo "Next step:"
echo "  scripts/run_qwen3_8b_jaws_de_lora_4090_v2_smoke.sh"
