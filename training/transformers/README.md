...
Dieser Ordner enthaelt den ersten lokal ausgefuehrten Qwen3-8B-QLoRA-Pilot fuer JAWS-DE.
...
- `requirements-qwen-pilot.txt` nennt die optionalen Laufzeit-Abhaengigkeiten fuer Training und Inferenz.
